...
<head>
    ...
    <title>แบบฟอร์มรับสมัครงาน - บริษัท GT จำกัด</title>
...
<div class="container my-5">
    <div class="card shadow-lg border-0">
        ...
        <div class="card-header bg-primary text-white text-center py-3">
            <h1 class="h3 mb-0">ใบสมัครงาน | บริษัท GT จำกัด</h1>
            ...
            <p class="mt-2 mb-0" style="font-size:14px; opacity:0.9;">
                จัดทำโดย: ชัชวาล สิงห์เทศ (แบงค์)
            </p>
        </div>
...
if(isset($_POST['Submit'])){
    ...
    $sql = "INSERT INTO app (app_id, app_position, app_prefix, app_fullname, app_birthday, app_education, app_skills, app_experience) VALUES (NULL, '{$position}', '{$prefix}', '{$fullname}','{$birthday}','{$education}','{$skills}','{$experience}')";
